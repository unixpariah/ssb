...
use crate::{util::helpers::combine_images, HotConfig, Position, StatusBar};
...
impl Surface {
    pub fn draw(
        ...
        let background = config.config.background;
        ...
        self.background = image::load_from_memory(&background).unwrap();
